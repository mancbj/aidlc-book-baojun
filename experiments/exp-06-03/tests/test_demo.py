"""Executable contract tests for EXP-06-03."""
...
class QuickstartContractTest(unittest.TestCase):
    ...
    def test_valid_sample_metrics(self):
        ...
        self.assertEqual(5400, report["metrics"]["completion_seconds"])
    ...
    def test_missing_required_stage_is_error(self):
        ...
        self.assertIn("[ERROR E_MISSING_STAGE]", completed.stderr)
    ...
    def test_invalid_samples_no_output(self):
        cases = {
            ...
            "invalid-timing.json": "E_INVALID_TIMING",
        }
        with tempfile.TemporaryDirectory() as temp_name:
