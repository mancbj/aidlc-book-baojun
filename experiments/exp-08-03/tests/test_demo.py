"""Executable contract tests for EXP-08-03."""
...
class QuickstartContractTest(unittest.TestCase):
    ...
    def test_valid_sample_metrics(self):
        ...
        self.assertEqual(100.0, report["metrics"]["stage_completion_percent"])
        self.assertEqual(100.0, report["metrics"]["rollback_readiness_percent"])
    ...
    def test_invalid_samples_no_output(self):
        cases = {
            ...
            "missing-stage.json": "E_MISSING_STAGE",
        }
        with tempfile.TemporaryDirectory() as temp_name:
