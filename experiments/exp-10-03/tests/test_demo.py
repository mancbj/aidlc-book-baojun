"""Executable contract tests for EXP-10-03."""
...
class QuickstartContractTest(unittest.TestCase):
    ...
    def test_valid_sample_metrics(self):
        ...
        self.assertEqual(0.0, report["metrics"]["handoff_information_loss_percent"])
        self.assertEqual(100.0, report["metrics"]["decision_agreement_percent"])
        self.assertEqual(7200, report["metrics"]["collaboration_seconds"])
    ...
    def test_invalid_samples_no_output(self):
        cases = {
            ...
            "missing-session.json": "E_MISSING_SESSION",
        }
        with tempfile.TemporaryDirectory() as temp_name:
