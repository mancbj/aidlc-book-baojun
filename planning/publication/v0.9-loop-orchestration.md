...
- **L1 v0.9.003**：PR 合入后 → 英文半本书 release-profile audit
- **L2–L6 v0.9.004–008**：分支 `cursor/v0.9.004-through-008-fdde`（英文全书 + Carbon 阅读站 + README 终稿）
- **Next after L6 merge**：`v0.9.009-draft` 维护循环（图优化 / 实验可视化，非 Reader 反馈驱动）
