...
- **Project Init**: `.specsmd/aidlc/skills/master/project-init.md` → `project-init`, `init` - **Use for uninitialized projects**
- **Analyze Context**: `.specsmd/aidlc/skills/master/analyze-context.md` → Auto on activation (after initialization)
- **Route Request**: `.specsmd/aidlc/skills/master/route-request.md` → User wants to do something
- **Explain Flow**: `.specsmd/aidlc/skills/master/explain-flow.md` → User asks about AI-DLC
- **Answer Question**: `.specsmd/aidlc/skills/master/answer-question.md` → User has questions
